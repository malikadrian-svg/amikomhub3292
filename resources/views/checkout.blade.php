...
<body class="bg-indigo-50/30 text-slate-900">
                ...
                <form id="checkout-form" action="{{ route('checkout.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="email" name="customer_email" id="input-email"
                        ...
                        <div>
                            ...
                            <input type="tel" name="customer_phone" id="input-phone"
    ...
    <div id="midtrans-overlay"
        ...
        <div class="bg-white w-full max-w-sm rounded-[2rem] overflow-hidden shadow-2xl animate-bounce-in">
            ...
            <div class="p-8 text-center">
                ...
                <p class="text-xs text-slate-400">Pilih metode pembayaran</p>

                <div class="mt-8 space-y-4">
                    {{-- Klik GoPay = submit form ke server --}}
                    ...
                    <button class="w-full py-4 border-2 border-indigo-100 rounded-2xl flex justify-between items-center px-6 transition group opacity-50 cursor-not-allowed">
    ...
    <script>
        ...
        function submitCheckout() {
            // Submit form ke server untuk simpan ke DB
