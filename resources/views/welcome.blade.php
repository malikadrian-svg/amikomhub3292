...
@section('content')
    ...
    <section id="events" class="max-w-7xl mx-auto px-6 py-20">
        ...
        <div class="mb-10">
            {{-- Label judul filter --}}
            <p class="text-center text-xs font-bold uppercase tracking-widest text-slate-400 mb-4">Filter berdasarkan kategori</p>

            {{-- Wrapper pill buttons: flex wrap & center --}}
            <div class="flex flex-wrap gap-3 justify-center items-center">

                {{-- Tombol "Semua Kategori" — aktif jika tidak ada parameter ?category --}}
                <a href="/"
                    class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-semibold text-sm border-2 transition-all duration-200
                        {{ !request('category')
                            ? 'bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-200 scale-105'
                            : 'bg-white border-slate-200 text-slate-600 hover:border-indigo-400 hover:text-indigo-600 hover:shadow-md' }}">
