...
<body class="bg-slate-50 text-slate-900">
    ...
    <nav
        ...
        <div class="hidden md:flex gap-8 font-medium">
            <a href="{{ route('home') }}"
                class="{{ request()->is('/') && !request('category') ? 'text-indigo-600 font-bold' : 'hover:text-indigo-600 transition' }}">Jelajahi</a>
            <a href="{{ route('home') }}#events" class="hover:text-indigo-600 transition">Kategori</a>
            <a href="{{ route('home') }}" class="hover:text-indigo-600 transition">Tentang Kami</a>
        </div>
    </nav>
