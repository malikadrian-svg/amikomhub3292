...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <form action="{{ route('admin.events.update', $event->id) }}" method="POST"
        ...
        <div class="mb-4">
            ...
            <textarea name="description" class="w-full border border-gray-300 p-2.5 rounded"
        ...
        <div class="mb-6">
            ...
            @if($event->poster_path)
                <div class="mb-2">
                    <p class="text-sm text-gray-500 mb-1">Poster saat ini:</p>
                    <img src="{{ Storage::url($event->poster_path) }}" alt="Poster" class="h-32 rounded border border-gray-200 object-cover">
                </div>
            @endif
            ...
            @enderror
            <p class="text-xs text-gray-400 mt-1">Biarkan kosong jika tidak ingin mengganti poster.</p>
        </div>
